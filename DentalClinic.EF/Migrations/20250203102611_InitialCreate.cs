        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Secondphone = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    PersonalIDNumber = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    InsuranceCardNumber = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlaceOfTreatment = table.Column<string>(type: "nvarchar(1)", maxLength: 1, nullable: false),
                    TypeOfTreatment = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Notice = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    Price = table.Column<double>(type: "float", maxLength: 5, nullable: false),
                    Discount = table.Column<double>(type: "float", maxLength: 5, nullable: false),
                    Total = table.Column<double>(type: "float", maxLength: 5, nullable: false),
                    VisitId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<int>(type: "int", nullable: false)
